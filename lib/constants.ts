...
export const DEPARTMENT_INFO = {
  ...
  established: "2023",
  programs: "Undergraduate program (B.Tech.), and Ph.D. (Doctor of Philosophy)",
  desc: "The department of Electronics and Communication Engineering (ECE) is started in the year 2023 which offers undergraduate program (B.Tech.), and Ph.D. (Doctor of Philosophy) with well experienced faculty who contribute immensely for the all-round development of students of the Department. ECE is a broad engineering field with sub fields - Analog/Digital electronics, VLSI, 4G/5G, Radio and Satellite Communications, Embedded systems, Signal & Image Processing, Robotics, IOT, Smart Cities, Edge Computing, AI, Quantum Circuitry, Nano-electronics, Photonics, Renewable Energy and many others. The ECE discipline utilizes various simulation, algorithms and fabrication tools to develop active/passive electrical devices that include diodes, transistors, semiconductors, and integrated circuits, etc to aid in design and fabrication of electronic circuits, devices, VLSI devices, PCB, Nano-devices and their various application systems.",
};
